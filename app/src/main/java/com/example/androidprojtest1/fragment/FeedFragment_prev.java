...
public class FeedFragment_prev extends Fragment {
    Context context;
...
//    InputMethodManager imm;
    ...
    public FeedFragment_prev(){

    }

    public FeedFragment_prev(Context context){
...
//        imm = (InputMethodManager) context.getSystemService(INPUT_METHOD_SERVICE);
        ...
        View view = inflater.inflate(R.layout.fragment_feed_prev, container, false);
...
//        ImageButton btnNewFeed = (ImageButton) view.findViewById(R.id.btnNewFeed);
        ...
        // newFeed init
        newFeedView = inflater.inflate(R.layout.activity_insert, container, false);
